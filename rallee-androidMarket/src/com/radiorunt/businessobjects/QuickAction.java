...
/**
 * QuickAction dialog, shows action list as icon and text. Currently supports
...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	// public static final int TYPE_PUBLIC_GROUP = 4;
	// public static final int TYPE_FB_GROUP = 5;
	// public static final int TYPE_RANDOM = 6;

	public static final int TYPE_MISSED_CALL = -1;
	public static final int CALL_UNSAVED_PRIVATE_GROUP = 9;// do not change

	public static String USERNAME = "";
	public static String FIRST_NAME = "";
	public static String GROUP_NAME = "";
	public static Long TIMESTAMP;
	public static int TYPE = TYPE_MISSED_CALL;
	...
	/**
	 * set type of call that will happen when clicking on Talk
	 */
	...
	/**
	 * report itsVulgar group to admin
	 */
	public void itsVulgar() {

	}

	/**
	 * report Support Racism group to admin
	 */
	public void supportRacism() {

	}

	/**
	 * report Hate conversation group to admin
	 */
	public void hateConversation() {

	}

	/**
	 * report Ceating Spam group to admin
	 */
	public void creatingSpam() {
