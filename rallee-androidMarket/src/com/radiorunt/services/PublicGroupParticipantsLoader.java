...
public class PublicGroupParticipantsLoader extends
	...
	public PublicGroupParticipantsLoader(Context context, int channelId) {
		super(context);
		mContext = context;
	...
	public PublicGroupParticipantsLoader(Context context) {
		super(context);
		mContext = context;
		mChannelId = -1;
	}
	...
	private RadioRuntService getRRService() {
		return ((HomeActivity) mContext).getRRService();
	}
	...
	public static class UsersReceiver extends BroadcastReceiver {
		final PublicGroupParticipantsLoader mLoader;

		public UsersReceiver(PublicGroupParticipantsLoader loader) {
			mLoader = loader;
